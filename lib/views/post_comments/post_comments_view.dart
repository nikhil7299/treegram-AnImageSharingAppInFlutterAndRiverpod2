...
import 'package:treegram/state/comments/providers/post_comments_provider.dart';
import 'package:treegram/state/comments/providers/send_comment_provider.dart';
...
import 'package:treegram/views/components/comment/comment_tile.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect(
      () {
        ...
        return () {
          //remove listener --- auto-removed when rebuilt
        };
      },
      [commentController],
    );
